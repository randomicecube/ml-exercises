...
\begin{enumerate}[leftmargin=\labelsep]
  ...
  \begin{enumerate}
    ...
    \item {
          ...
          \begin{align*}
            ...
            \right) + \cdots = \input{aux-matrices/ex-2/w_2}
          \end{align*}
    ...
    \item {
          ...
          $$
            ...
            \input{aux-matrices/ex-3/x_1} \cdot \left(
              ...
              \right)
            \right) + \cdots = \input{aux-matrices/ex-3/w_2}
          $$
  ...
  the parameter $w$ under the assumption that the data is generated by a Bernoulli
  distribution. As such, the cross-entropy loss function is the negative log-likelihood
